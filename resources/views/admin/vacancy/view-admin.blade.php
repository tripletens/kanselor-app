...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xs-12 col-lg-6">
            <div class="card">
                <div class="card-body">
                    <table class="p-3 d-flex justify-content-center table table-responsive table-striped">
                        <tr>
                            <th>Vacancy ID: </th>
                        ...
                        <tr>
                            <th>Category Name: </th>
                            <td>
                                <span class="badge badge-info">{{ucwords($admin_vacancy->category_name)}} </span>
                            </td>
                        </tr>
                        <tr>
                            <th>Title: </th>
                        ...
                        <tr>
                            <td colspan="2" aria-colspan="2">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">{{ucwords($admin_vacancy->title)}} <span class="badge badge-success"> {{$admin_vacancy->code}}</span></h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST" action="{{route('admin.edit_vacancy')}}">
                                                    @csrf
                                                    <input type="hidden" name="vacancy_id" value="{{$admin_vacancy->id}}" />
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label for="title"> Title: <span class="text-danger"> *</span></label>
                                                                <input type="text" name="title" value="{{ucwords($admin_vacancy->title)}}" required class="form-control @error('title') is-invalid @enderror" placeholder="Enter Vacancy Title i.e Driver Needed" />
                                                                @error('title')
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <textarea class="form-control @error('description') is-invalid @enderror" name="description" placeholder="Give us more details about the position">{{ucfirst($admin_vacancy->description) }}</textarea>
                                                                @error('description')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" min="0" name="experience" required class="form-control @error('experience') is-invalid @enderror" value="{{$admin_vacancy->experience}}" placeholder="What's the minimum number of years of experience" />
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="qualification">Qualification: <span class="text-danger"> *</span></label>
                                                                <select name="qualification" class="form-control @error('experience') is-invalid @enderror" required value="{{$admin_vacancy->qualification}}">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" placeholder="Enter minimum age limit" class="form-control @error('from_age') is-invalid @enderror" value="{{$admin_vacancy->from_age}}" min="18" name="from_age">
                                                                @error('from_age')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" placeholder="Enter maximum age limit" class="form-control @error('to_age') is-invalid @enderror" value="{{$admin_vacancy->to_age}}" min="18" name="to_age">
                                                                @error('to_age')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                ...
                                <div class="modal fade" id="deleteModal{{$admin_vacancy->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">{{ucwords($admin_vacancy->title)}} <span class="badge badge-success"> {{$admin_vacancy->code}}</span></h5>
