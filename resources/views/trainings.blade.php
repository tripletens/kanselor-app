                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="row">
                            ...
                            <div class="featured-item">
                                ...
                                <div class="down-content">
                                    ...
                                    <div class="text-button">
                                       ...
                                       <a href="{{route('training-one-page',$training->slug)}}">Apply</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info d-flex justify-content-center">
                            <h3 class="text-center" style="font-size: 24px;text-align:center;"> No Trainings Available at the Moment</h3>
                        </div>
                        @endif
                    </div>
                </div>
